        ...
        with psycopg.connect(**params) as conn:
            with conn.cursor() as cur:
                ...
                if table_exists:
                    ...
                    print(f"✅ music_transactions table exists with {record_count} records")
                else:
...
def test_snowflake_connection():
    ...
    try:
        ...
        print(f"📡 Connecting to: {connection_params['user']}@{connection_params['account']}")
        print(f"🏢 Database: {connection_params['database']}.{connection_params['schema']}")
            ...
            with conn.cursor() as cur:
                ...
                try:
                    ...
                    try:
                        ...
                        record_count = cur.fetchone()[0]
                        print(f"✅ RAW_DATA_POSTGRE table exists with {record_count} records")
                    except Exception as table_error:
                        print(f"❌ RAW_DATA_POSTGRE table not accessible: {table_error}")
                        return False
        ...
        print("❌ snowflake-connector-python module not found. Install with: pip install snowflake-connector-python")
        return False
    except Exception as e:
...
def test_environment_variables():
    ...
    required_vars = {
        ...
        "Snowflake": [
            "SNOWFLAKE_ACCOUNT", "SNOWFLAKE_USER", "SNOWFLAKE_PRIVATE_KEY_FILE_PATH",
            "SNOWFLAKE_PRIVATE_KEY_FILE_PWD", "SNOWFLAKE_WAREHOUSE", 
        ...
        for var in vars_list:
            ...
            if value:
                ...
                if "PASSWORD" in var or "PWD" in var:
                    ...
                    display_value = f"{value[:10]}...{value[-10:]}" if len(value) > 20 else "*" * len(value)
                else:
                    display_value = value
